      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="marble-card rounded-xl p-6 mb-8 animate-fade-in">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-['Cinzel',serif] text-xl font-semibold text-[var(--slate-800)]">
              視覺化分析
            </h3>
            ...
            <ResponsiveContainer width="100%" height="100%">
              {chartType === 'bar' ? (
                <BarChart data={chartData}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="第一名次數" fill="#10b981" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="第二名次數" fill="#64748b" radius={[4, 4, 0, 0]} />
                  {selectedModels.length > 2 && (
                    <Bar dataKey="第三名次數" fill="#d97706" radius={[4, 4, 0, 0]} />
                  )}
                </BarChart>
              ) : (
